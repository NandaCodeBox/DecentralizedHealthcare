# Generate Mobile Demo Voiceover using AWS Polly
# Uses Aditi voice (Indian English female)

$scriptPath = "mobile-demo-voiceover.txt"
$outputPath = "mobile-demo-voiceover.mp3"
...
Write-Host ""
Write-Host "Next step: Run python combine-mobile-video.py" -ForegroundColor Yellow
