#!/usr/bin/env python3
"""
Generate sharp 3-minute voiceover for Hackathon Demo
Concise script with immediate start
"""
...
def generate_voiceover():
    print("=" * 80)
    print("GENERATING 3-MINUTE VOICEOVER (SHARP & CONCISE)")
    print("Using AWS Polly (Aditi - Indian English)")
    print("=" * 80)
    
    # Read the voiceover script
    with open('Video/hackathon-3min-voiceover.txt', 'r', encoding='utf-8') as f:
        content = f.read()
    ...
    try:
        ...
        for i, segment_text in enumerate(segments, 1):
            ...
            # Save segment audio
            segment_file = f'Video/voiceover-3min-segment{i}.mp3'
        ...
        # Create concat file
        with open('Video/concat_3min.txt', 'w') as f:
            for audio_file in audio_files:
                f.write(f"file '{os.path.basename(audio_file)}'\n")
        
        # Combine using ffmpeg
        output_file = 'Video/hackathon-3min-voiceover.mp3'
        subprocess.run([
            'ffmpeg', '-f', 'concat', '-safe', '0',
            '-i', 'Video/concat_3min.txt',
        ...
        os.remove('Video/concat_3min.txt')
...
if __name__ == '__main__':
    print("\nGenerating sharp 3-minute voiceover...\n")
    ...
    if output:
        ...
        print("\nNext step:")
        print("  python Video/combine-3min-demo.py")
    else:
        print("\n" + "=" * 80)
        print("FAILED")
        print("=" * 80)
