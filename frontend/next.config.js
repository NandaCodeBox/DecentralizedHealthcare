...
const withPWA = require('next-pwa')({
  ...
  sw: 'sw-custom.js',
  runtimeCaching: [
    // Critical resources - Cache First with long expiration
    {
    ...
    // JavaScript files - Stale While Revalidate
    {
      urlPattern: /\.(?:js)$/i,
      handler: 'StaleWhileRevalidate',
      options: {
    ...
    // API calls - Network First with bandwidth awareness
    {
      urlPattern: /\/api\/.*$/i,
      handler: 'NetworkFirst',
      method: 'GET',
    ...
    // Everything else - Network First with shorter timeout
    {
      urlPattern: /.*/i,
      handler: 'NetworkFirst',
      options: {
...
const nextConfig = {
  ...
  // Image optimization for bandwidth - disable for static export
  images: {
